    ...
    <main className="relative flex min-h-screen flex-col items-center bg-gradient-to-br from-mirage-950 via-mirage-900 to-mirage-950">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
        ...
        <div className="bg-gradient-to-br from-mirage-900/80 to-mirage-950/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 sm:p-10 border-2 border-spring-green-500/30 hover:border-spring-green-400/60 transition-all duration-500 animate-in fade-in slide-in-from-bottom" style={{ animationDuration: '1000ms' }}>
          ...
          <div className="space-y-4 text-gray-300 leading-relaxed text-lg mb-6">
            <p className="hover:text-gray-200 transition-colors duration-300">
              Level up your game with our expert guides. From mastering individual minigames to planning full heist operations, our in-depth articles cover strategies, techniques, and tips used by the best players.
            </p>
          </div>
          <div className="grid sm:grid-cols-3 gap-4">
            <Link href="/guides/mastering-thermite" className="group bg-mirage-800/50 hover:bg-mirage-800 rounded-lg p-4 border border-spring-green-500/20 hover:border-spring-green-400/50 transition-all duration-300">
              <h3 className="font-bold text-white group-hover:text-spring-green-300 transition-colors mb-2">🔥 Mastering Thermite</h3>
              <p className="text-gray-400 text-sm">Memory techniques and strategies for the hardest hack</p>
            </Link>
            <Link href="/guides/nopixel-heist-guide" className="group bg-mirage-800/50 hover:bg-mirage-800 rounded-lg p-4 border border-spring-green-500/20 hover:border-spring-green-400/50 transition-all duration-300">
              <h3 className="font-bold text-white group-hover:text-spring-green-300 transition-colors mb-2">🎯 Heist Planning Guide</h3>
              <p className="text-gray-400 text-sm">Everything about crew roles, heist tiers, and preparation</p>
            </Link>
            <Link href="/guides/improving-reaction-time" className="group bg-mirage-800/50 hover:bg-mirage-800 rounded-lg p-4 border border-spring-green-500/20 hover:border-spring-green-400/50 transition-all duration-300">
              <h3 className="font-bold text-white group-hover:text-spring-green-300 transition-colors mb-2">⚡ Reaction Time Training</h3>
              <p className="text-gray-400 text-sm">Science-backed techniques to improve your speed</p>
            </Link>
          </div>
          <div className="pt-4">
            <Link href="/guides" className="inline-flex items-center gap-2 text-spring-green-400 hover:text-spring-green-300 font-semibold transition-colors duration-300">
              View all guides →
            </Link>
          </div>
        </div>
      ...
      <footer className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center text-gray-500 border-t-2 border-spring-green-500/30 mt-12">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm">
          ...
          <span className="text-gray-700">•</span>
          <Link href="/guides" className="hover:text-spring-green-400 transition-colors duration-300">
            Guides
          </Link>
        </div>
      </footer>
